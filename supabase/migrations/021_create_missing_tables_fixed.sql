-- Create missing tables identified in the project plan (FIXED SYNTAX)
...
CREATE INDEX IF NOT EXISTS idx_inventory_reservations_session_id ON public.inventory_reservations(session_id);
